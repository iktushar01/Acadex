                ...
                >
                  ...
                  >
                    ...
                    <div className="relative p-6 z-10">
                      ...
                      <div 
                        className={`mb-4 w-16 h-16 rounded-lg bg-gradient-to-br ${feature.gradient} flex items-center justify-center shadow-lg group-hover:scale-110 group-hover:rotate-6 transition-all duration-300 relative`}
                        style={{
                      ...
                      >
                        ...
                        <span className={`absolute bottom-0 left-0 w-full h-0.5 bg-gradient-to-r ${feature.gradient} opacity-30 group-hover:opacity-60 transition-opacity`} />
                      </h3>
