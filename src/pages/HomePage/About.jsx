      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="text-center space-y-6 mb-20 pl-4 lg:pl-0">
            ...
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto pl-4 border-l-4 border-primary/30 leading-relaxed">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 pl-4 lg:pl-0">
